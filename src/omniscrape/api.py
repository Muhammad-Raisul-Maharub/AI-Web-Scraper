# src/omniscrape/api.py - FastAPI Headless REST API for OmniScrape AI
import os
import sys
import time
...
from .storage.db import save_scrape, save_extraction, get_recent_scrapes, get_recent_extractions, detect_price_changes
